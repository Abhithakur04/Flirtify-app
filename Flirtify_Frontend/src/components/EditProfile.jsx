...
const EditProfile = ({ user }) => {
  ...
  return (
    <>
          <div className="flex flex-col md:flex-row justify-center min-h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 overflow-auto py-8 gap-6">
      ...
      <div className="sm:my-4 mx-7 lg:my-4 flex justify-center sm:w-[300px]">
          <UserCard
