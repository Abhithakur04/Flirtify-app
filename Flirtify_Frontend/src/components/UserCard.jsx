...
//         {about && (
//           <p className="flex-grow-0  overflow-y-auto  whitespace-nowrap  resize-none">
//             {about}
//           </p>
//         )}
//         <div class="card-actions flex gap-4 justify-center mt-2">
//           <button
//             class="btn btn-primary px-6 py-2 text-white bg-green-500 rounded-lg hover:bg-green-600 transition-colors"
//             onClick={() => handleSendRequest("ignored", _id)}
//           >
//             Ignored
//           </button>
//           <button
//             class="btn btn-secondary px-6 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 transition-colors"
...
const UserCard = ({ user }) => {
  ...
  return (
    <div className="card bg-base-300 sm:w-[10rem] lg:w-[30rem] shadow-xl rounded-xl p-6">
      <figure>
        <img
